import { BaseComponentOptionsWithPayload, EmitterContract, VoiceCallContract, VoiceCallDisconnectReason, VoicePlaylist, VoiceCallPlayAudioMethodParams, VoiceCallPlaySilenceMethodParams, VoiceCallPlayRingtoneMethodParams, VoiceCallPlayTTSMethodParams, VoiceCallRecordMethodParams, VoiceCallPromptMethodParams, VoiceCallPromptAudioMethodParams, VoiceCallPromptRingtoneMethodParams, VoiceCallPromptTTSMethodParams, VoiceCallCollectMethodParams, VoiceCallTapMethodParams, VoiceCallTapAudioMethodParams, CallingCallState, VoiceCallConnectMethodParams, VoiceCallConnectPhoneMethodParams, VoiceCallConnectSipMethodParams, CallingCallConnectEventParams, VoiceCallDetectMethodParams, VoiceCallDetectMachineParams, VoiceCallDetectFaxParams, VoiceCallDetectDigitParams, CallingCallWaitForState, CallingCall, configureStore, BaseConsumer } from '@signalwire/core';
...
export declare type EmitterTransformsEvents = 'calling.playback.start' | 'calling.playback.started' | 'calling.playback.updated' | 'calling.playback.ended' | 'calling.playback.failed' | 'calling.recording.started' | 'calling.recording.updated' | 'calling.recording.ended' | 'calling.recording.failed' | 'calling.prompt.started' | 'calling.prompt.updated' | 'calling.prompt.ended' | 'calling.prompt.failed' | 'calling.tap.started' | 'calling.tap.ended' | 'calling.detect.started' | 'calling.detect.ended' | 'calling.collect.started' | 'calling.collect.updated' | 'calling.collect.ended' | 'calling.collect.failed' | 'calling.call.state' | 'calling.detect.updated' | 'calling.connect.connected';
export interface CallOptions extends BaseComponentOptionsWithPayload<CallingCall> {
...
export declare class CallConsumer extends BaseConsumer<RealTimeCallApiEvents> {
    private _peer;
    private _payload;
    ...
    get callState(): CallingCallState;
    get tag(): string;
    get nodeId(): string;
    get device(): import("@signalwire/core").CallingCallPhoneDevice | import("@signalwire/core").CallingCallSIPDevice;
    ...
    get direction(): import("@signalwire/core").CallingCallDirection;
    get context(): string | undefined;
    get connectState(): "connected" | "disconnected" | "failed" | "connecting";
    get peer(): Call | undefined;
    set peer(callInstance: Call | undefined);
    /** @internal */
    protected setPayload(payload: CallingCall): void;
    /** @internal */
    protected setConnectPayload(payload: CallingCallConnectEventParams): void;
    /**
     * Hangs up the call.
...
export declare const createCallObject: (params: CallOptions) => Call;
