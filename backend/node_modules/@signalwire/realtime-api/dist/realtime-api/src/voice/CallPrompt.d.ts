import { BaseComponentOptionsWithPayload, VoiceCallPromptContract, CallingCallCollectEventParams, EventEmitter, BaseConsumer } from '@signalwire/core';
/**
...
export interface CallPromptOptions extends BaseComponentOptionsWithPayload<CallingCallCollectEventParams> {
}
export declare class CallPromptAPI extends BaseConsumer<CallPromptEventsHandlerMapping> implements VoiceCallPromptContract {
    private _payload;
    ...
    /** @internal */
    protected setPayload(payload: CallingCallCollectEventParams): void;
    stop(): Promise<this>;
