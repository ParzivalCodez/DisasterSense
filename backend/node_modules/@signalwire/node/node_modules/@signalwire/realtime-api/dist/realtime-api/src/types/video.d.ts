 ...
 * RealTime Video API
 */
export declare type RealTimeVideoEventsHandlerMapping = Record<GlobalVideoEvents, (room: RoomSession) => void>;
export declare type RealTimeVideoEvents = {
...
export declare type RealTimeVideoListenersEventsMapping = {
...
export declare type RealtimeRoomPlaybackListenersEventsMapping = Record<'onStarted', PlaybackStarted> & Record<'onUpdated', PlaybackUpdated> & Record<'onEnded', PlaybackEnded>;
/**
 * RealTime Room CallRecording API
 */
export declare type RealTimeRoomRecordingEvents = Record<VideoRecordingEventNames, (recording: RoomSessionRecording) => void>;
...
export declare type RealtimeRoomRecordingListenersEventsMapping = Record<'onStarted', RecordingStarted> & Record<'onUpdated', RecordingUpdated> & Record<'onEnded', RecordingEnded>;
/**
 * RealTime Room CallStream API
 */
export declare type RealTimeRoomStreamEvents = Record<VideoStreamEventNames, (stream: RoomSessionStream) => void>;
...
export declare type RealtimeRoomStreamListenersEventsMapping = Record<'onStarted', StreamStarted> & Record<'onEnded', StreamEnded>;
export {};
