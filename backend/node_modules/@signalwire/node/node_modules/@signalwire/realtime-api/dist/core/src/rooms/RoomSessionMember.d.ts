...
export declare class RoomSessionMemberAPI extends BaseComponent<RoomSessionMemberEventsHandlerMapping> {
    ...
    get requestedPosition(): import("packages/realtime-api/src/video/Video").VideoPosition;
    get currentPosition(): import("packages/realtime-api/src/video/Video").VideoPosition | undefined;
    get visible(): boolean;
